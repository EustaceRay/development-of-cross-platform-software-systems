...
FILE_NAME=pasart.py
WINDOWS_SOURCE=.\pasart.py
LINUX_SOURCE=`pwd`/pasart.py
BSD_SOURCE=./pasart.py
...
windows:
	...
	$(WINDOWS_OUTPUT)\pasart.exe

web:
	@echo "Building for web..."
	pip install flask
	python WebWithTemplates\app.py
