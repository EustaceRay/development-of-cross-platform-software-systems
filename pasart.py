...
# Double Pascal's triangles
elif option == '2':
  n = size
  z = size

  # Build the upper left half
  for r in range(n):
    for c in range(z - 1):
      if r == 0 or c == 0:
        p[r][c] = 1
...
# Four Pascal's triangles in the corner of a square array
elif option == '3':
  y = size
  z = size // 2
  z1 = z
